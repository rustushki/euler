...
void heap::insert(char* value) {

}

void heap::increase_key(int index, char* value) {
	// TODO: What if value is less than that of index?  Should error out.
	// Initial implementation is to be used by insert (which always puts at very bottom)
}
